...
The `movie_content_df` has 4000 rows representing an observation for each of the 4000 unique movies. The `movie_reviews_df` has 9602 rows representing a user rating for 2540 unique movies.
