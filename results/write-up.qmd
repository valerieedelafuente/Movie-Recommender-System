...
-   Fit a KNN model that uses cosine similarity as the distance metric and the
...
-   talk about the cascade approach

-   how it starts with content then runs through collaborative if the movie has user reviews
