...
![](images/Screen Shot 2025-03-19 at 12.51.43 PM-01.png)
...
![](images/Screen Shot 2025-03-19 at 12.43.27 PM.png)
...
![](images/Screen Shot 2025-03-19 at 12.43.07 PM.png)
...
![](images/Screen Shot 2025-03-19 at 12.34.50 PM.png)

About 1750 of movies are categorized under Drama, making it the most popular genre. Comedy and Thriller follow closely behind with approximately 1200 and 1000 counts. This suggests that these genres dominate the dataset, potentially representing popular trends in the movie industry.
...
![](images/Screen Shot 2025-03-19 at 12.35.40 PM.png)
...
![](images/Screen Shot 2025-03-19 at 12.36.07 PM.png)

As we can see "Jr." is the most common actor in our movie dataset with a count of approximately 85. We do not know who exactly "Jr." is, but we believe the name was cut when retrieving the data. Other actors such as Samuel L. Jackson, and Willem Dafoe were also common with counts of approximately 45 and 42.
...
![](images/Screen Shot 2025-03-19 at 12.36.35 PM.png)
...
![](images/Screen Shot 2025-03-19 at 12.39.55 PM.png)

'CinemaSerf' is our top reviewer, contributing reviews for approximately 1200 movies. Following closely behind are 'r96sk' and 'Gimly' with approximately 600 and 400 movie reviews. It would be interesting to explore if their reviews are concentrated in particular genres or if they are more diverse.
...
def content_based_movie_recs(movie_title, movie_content_df, cosine_sim, top_n=11):
    ...
    recommendations = movie_content_df.iloc[[i[0] for i in top_movies]][["title", "genre_ids", "rating_average", 'movie_id']]
